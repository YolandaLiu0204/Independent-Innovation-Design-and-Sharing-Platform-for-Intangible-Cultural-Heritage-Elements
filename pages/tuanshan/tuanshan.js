...
Page({
  ...
  data: {
    //itemList: [],
    stickers: [
      '../images/creation/stickers/sticker1.png',
      '../images/creation/stickers/sticker2.png',
      '../images/creation/stickers/sticker3.png',
      '../images/creation/stickers/sticker4.png',
      '../images/creation/stickers/sticker5.png',
      '../images/creation/stickers/sticker6.png',
      '../images/creation/stickers/sticker7.png',
      '../images/creation/stickers/sticker8.png',
      '../images/creation/stickers/sticker1.png',
      '../images/creation/stickers/sticker2.png'],
  },
  ...
  onLoad: function(options) {
    ...
    // this.drawTime = 0
    // this.setDropItem({
    //   url: '../images/creation/stickers/1.png'
    // });
    // this.setDropItem({
    //   url: '../images/creation/stickers/1.png'
    // });
  ...
  synthesis() { // 合成图片
    ...
    maskCanvas.drawImage('../images/creation/bg2.png', 0, 0, this.data.canvasWidth, this.data.canvasHeight);
    /*
    ...
    items.forEach((currentValue, index) => {
      ...
      maskCanvas.beginPath();
      maskCanvas.translate(currentValue.x * prop, currentValue.y * prop-60); //圆心坐标
